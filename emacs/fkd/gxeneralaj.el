...
(setq user-full-name "Rommel MARTINEZ"
      user-mail-address "ebzzry@ebzzry.io"
      ...
      time-stamp-format "la %:d-an de %:b %Y"
      time-stamp-pattern "^Laste ŝanĝita: %%$"

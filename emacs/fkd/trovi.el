...
(def-find esgxenaralaj (stumpwm-path "gxeneralaj.lisp"))
(def-find eskomandoj (stumpwm-path "komandoj.lisp"))
(def-find esklavoj (stumpwm-path "klavoj.lisp"))
(def-find esfenestroj (stumpwm-path "fenestroj.lisp"))
(def-find esgrupoj (stumpwm-path "grupoj.lisp"))
(def-find esswanko (stumpwm-path "swanko.lisp"))
